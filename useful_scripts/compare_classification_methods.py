...
print("Accuracy for KNN on 25% Testing Set:",metrics.accuracy_score(y_test, y_pred))

#Decision Tree
tree = DecisionTreeClassifier().fit(x_train, y_train)
print("\nAccuracy for Decision Tree classifier on Training set:",tree.score(x_train_full_2, y_train_full))
print("Accuracy for Decision Tree classifier on 25% Testing set:",tree.score(x_test, y_test))
...
print("Accuracy for Logistic Regression on 25% Testing set:",log.score(x_test, y_test))
...
print("Accuracy for SVM classifier on 25% Testing set:",svm.score(x_test, y_test))

#Linear Discriminant Analysis
lda = LinearDiscriminantAnalysis()
lda.fit(x_train, y_train)
print("\nAccuracy for LDA classifier on Training set:",lda.score(x_train_full_2, y_train_full))
print("Accuracy for LDA classifier on 25% Testing set:",lda.score(x_test, y_test))

#Gaussian Naive Bayes
gnb = GaussianNB()
gnb.fit(x_train, y_train)
print("\nAccuracy for GNB classifier on Training set:",gnb.score(x_train_full_2, y_train_full))
print("Accuracy for GNB classifier on 25% Testing set:",gnb.score(x_test, y_test))
...
print("Accuracy for MLP on 25% Testing Set:",r2_score(y_pred_mlp, y_test))